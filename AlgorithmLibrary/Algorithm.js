...
{	
	...
	var controlBar = document.getElementById("AlgorithmSpecificControls");
	var printBar = document.getElementById("AlgorithmPrint");
...
function addControlToAlgorithmBar(type, name) {
	...
	// element.style.marginRight = '3cm'
//    element.setAttribute("name", name);

if(element.type == 'button'){
	element.className = 'btn btn-outline-primary';
	element.style.marginRight = '2cm'
...
function addPrintBar(textValue)
{	
	var element = document.createElement("li");
	element.className = 'list-group-item';
	element.innerText = textValue;
	var printBar = document.getElementById("AlgorithmPrint");
    printBar.appendChild(element);
	return element;
}
